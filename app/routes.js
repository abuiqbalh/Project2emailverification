...
module.exports = function(app,passport) {
    ...
    app.post("/email",isLoggedIn,function(req,res){
        ...
        connection.query('select * from users where id = ?',[req.user.id], function (err, rows) {
            ...
            sendMail(email,code,function(err){
			console.log(err)});
        });
...
function sendMail(mail_adress,code){
    ...
    console.log(" test test test "+mail,code);
    ...
    var mailOptions = {
      from: 'bootcampp53@gmail.com',
      to: mail,
      subject: 'click this button',
      text: 'Hello from BootCamp Project-2. If you get this mail, Horray email sent successfully.',

      html: " <a href='http://127.0.0.1/verification/"+code+"'> http://127.0.0.1/verification/"+code+"  </a> '<p>Hello from BootCamp Project-2. If you get this mail, Horray email sent successfully.</p>' "
    };
